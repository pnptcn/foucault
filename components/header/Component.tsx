...
export const Component: React.FC = () => {
    const renderLogo = () => (
        <EuiHeaderLogo iconType="logoElastic" href="#" onClick={(e) => e.preventDefault()} aria-label="Header Logo" />
    )
        ...
        <EuiSelectableTemplateSitewide
            ...
            emptyMessage={
                <EuiSelectableMessage style={{ minHeight: 300 }}>
                    <p>Please see the component page for on how to configure your sitewide search.</p>
                </EuiSelectableMessage>
            }
        />
    )
